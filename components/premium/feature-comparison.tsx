  ...
  return (
    <div className="mb-16">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#00FF85] to-purple-500 inline-block mb-4">Premium Features Comparison</h2>
        <p className="text-gray-300">Find the perfect plan for your Discord community</p>
      </div>
      <div className="glass-dark border border-[#00FF85]/20 rounded-lg p-8 relative overflow-hidden">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-700">
                ...
                <th className="text-center py-4 px-4 text-[#00FF85] font-medium">Prime</th>
            ...
            <tbody>
              <tr className="border-b border-gray-800">
                ...
                <td className="py-3 px-2 text-center">
                  <Check className="h-5 w-5 text-[#00FF85] mx-auto" />
                </td>
                <td className="py-3 px-2 text-center">
