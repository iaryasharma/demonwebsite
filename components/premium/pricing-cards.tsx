...
export function PricingCards() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
      {/* Demon Prime */}
      <Card className="glass-dark border-[#8b5cf6]/30 overflow-hidden relative transform transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(139,92,246,0.3)]">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#8b5cf6] to-blue-500"></div>
        <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-[#8b5cf6] to-blue-500 rounded-full opacity-20"></div>
        <CardHeader className="pb-0">
          <div className="flex items-center mb-2">
            <div className="mr-3 bg-gradient-to-br from-[#8b5cf6]/20 to-blue-500/20 p-2 rounded-full select-none" style={{ pointerEvents: 'none' }}>
          ...
          <ul className="space-y-3">
            <li className="flex items-center">
              <Check className="h-5 w-5 text-[#8b5cf6] mr-2 flex-shrink-0" />
          ...
          <Button 
            className="w-full bg-[#8b5cf6] text-black hover:bg-[#8b5cf6]/80"
      ...
      <Card className="glass-dark border-purple-500/30 overflow-hidden relative transform transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(168,85,247,0.3)]">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#8b5cf6] to-purple-500"></div>
        <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-purple-500 to-[#8b5cf6] rounded-full opacity-20"></div>
        <div className="absolute top-4 right-4 z-10">
          <Badge className="bg-gradient-to-r from-pink-500 to-purple-500 text-white font-medium px-3 py-1">Most Popular</Badge>
        </div>
        <CardHeader className="pb-0">
          <div className="flex items-center mb-2">
            <div className="relative mr-3 bg-gradient-to-br from-purple-500/20 to-[#8b5cf6]/20 p-2 rounded-full select-none" style={{ pointerEvents: 'none' }}>
        ...
        <CardContent className="pt-6">
          ...
          <Button 
            className="w-full bg-gradient-to-r from-[#8b5cf6] to-purple-500 text-black hover:opacity-90"
            onClick={() => window.open('https://discord.com/oauth2/authorize?client_id=836880109478608897&scope=bot%20identify%20guilds%20applications.commands&response_type=code&permissions=1513962695871&state=QGn-6VzBYf2Ta8nMk_tFe', '_blank')}
          >
            Get Started
          </Button>
